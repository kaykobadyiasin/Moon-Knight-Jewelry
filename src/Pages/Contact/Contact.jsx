...
const Contact = () => {
    return (
        <div>
            <PageBanner image={'https://images.unsplash.com/photo-1569173675610-42c361a86e37?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2067&q=80'} title={'Contact Us'} subtitle={'Lorem ipsum dolor sit amet ipsum to duram.'} />
            ...
            <div className="bg-gradient-to-b py-16">
                <div className="max-w-screen-xl mx-auto px-4">
                    <h1 className="text-4xl font-semibold mb-8">Get in Touch with Js Sports and Uniforms</h1>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="p-6 rounded-lg shadow-lg">
                            <h2 className="text-2xl font-semibold mb-4">Contact Information</h2>
                            <p className="space-y-5">
                                <p><strong>Email:</strong> Jssports@btconnect.com</p>
                                <p><strong>Phone:</strong> 01582 494401</p>
